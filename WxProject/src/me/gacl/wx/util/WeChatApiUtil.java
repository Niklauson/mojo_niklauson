...
public class WeChatApiUtil {
	...
	public static File downloadMedia(String fileName, String mediaId) {
		String appId = "wx24f1cd2da389c118";
		String appSecret = "0e7460959a22cb3513ed11eae9780080";
	...
	public static void main(String[] args) throws Exception {
		// 媒体文件路径
		String filePath = "C:/Users/Mojo/Desktop/123/1.jpg";
		// String filePath =
		// "D:/JavaSoftwareDevelopeFolder/IntelliJ IDEA_Workspace/WxStudy/web/media/voice/voice.mp3";
		// String filePath =
		// "D:\\JavaSoftwareDevelopeFolder\\IntelliJ IDEA_Workspace\\WxStudy\\web\\media\\video\\小苹果.mp4";
		// 媒体文件类型
		String type = "image";
		// String type = "voice";
		// String type = "video";
